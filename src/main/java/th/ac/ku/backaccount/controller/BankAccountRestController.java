package th.ac.ku.backaccount.controller;

import org.springframework.web.bind.annotation.*;
import th.ac.ku.backaccount.data.BankAccountRepository;
...
public class BankAccountRestController {
    ...
    @PutMapping("/{id}")
    public BankAccount updat(@PathVariable int id, @RequestBody BankAccount bankAccount) {
